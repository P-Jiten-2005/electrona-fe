      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-20 w-full max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="flex flex-col font-display leading-[1.0] text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black select-none gap-2">
            <span className="relative inline-block text-[#FF6A00] hover:text-neutral-900 transition-colors duration-300 group cursor-default">
              FUEL.
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-neutral-50 via-white to-neutral-100 border border-neutral-200 rounded-[2rem] p-6 shadow-2xl flex flex-col justify-between overflow-hidden group">
              ...
              <div className="flex justify-between items-start">
                <div className="flex flex-col">
                  ...
                  <span className="font-mono text-[10px] text-neutral-600 uppercase tracking-widest mt-1 font-semibold">3-IN-1 HYDRATION ENGINEERING KIT</span>
                </div>
              </div>
              ...
              <div className="my-auto flex flex-col justify-center items-center relative py-6">
                ...
                <div className="relative w-full h-32 flex justify-center items-center">
                  ...
                  <div className="absolute left-2 bottom-2 w-[85px] h-[105px] bg-gradient-to-b from-[#FF6B00] to-neutral-900 border border-[#FF6B00]/40 rounded-lg shadow-lg rotate-[-12deg] transform-gpu hover:translate-y-[-10px] transition-all duration-300 cursor-pointer flex flex-col justify-between p-2">
                    <span className="font-display text-[10px] font-black text-white leading-none tracking-wide">PRE_MATCH</span>
                    <span className="font-mono text-[6px] text-zinc-250 font-semibold">FOCUS IGNITE // S01</span>
                    <div className="w-full h-0.5 bg-brand-orange opacity-40" />
                  </div>

                  {/* Sachet 3: POST-MATCH (Green, Layer behind right) */}
                  <div className="absolute right-2 bottom-2 w-[85px] h-[105px] bg-gradient-to-b from-[#00E575] to-neutral-900 border border-[#00E575]/40 rounded-lg shadow-lg rotate-[12deg] transform-gpu hover:translate-y-[-10px] transition-all duration-300 cursor-pointer flex flex-col justify-between p-2">
                    <span className="font-display text-[10px] font-black text-white leading-none tracking-wide">POST_MATCH</span>
                    <span className="font-mono text-[6px] text-zinc-250 font-semibold">RECOVER RESET // S03</span>
                    <div className="w-full h-0.5 bg-[#00E575] opacity-40" />
                  </div>

                  {/* Sachet 2: DURING-MATCH (Electric Cyan, Centered Top) */}
                  <div className="absolute z-10 w-[102px] h-[120px] left-1/2 -translate-x-1/2 bottom-5 bg-gradient-to-b from-[#00D9FF] via-neutral-950 to-neutral-850 border-2 border-[#00D9FF]/70 rounded-lg shadow-2xl scale-105 transform hover:scale-110 hover:translate-y-[-10px] transition-all duration-300 cursor-pointer flex flex-col justify-between p-2.5">
                    <div className="w-full text-center font-display text-[11px] font-black text-white leading-none tracking-wider">DURING_MATCH</div>
                    <div className="w-full text-center font-mono text-[7px] text-neutral-200 uppercase tracking-widest font-bold">ENDURANCE FLOW // S02</div>
                    <div className="flex justify-center items-center bg-[#00D9FF]/10 px-1.5 py-0.5 rounded text-[6px] font-mono text-[#00D9FF] font-bold">
              ...
              <div className="flex justify-between items-end border-t border-neutral-250 pt-3">
                ...
                <span className="font-mono text-[7px] text-[#006F85] font-extrabold">NET VOL: 3X PACK</span>
              </div>
