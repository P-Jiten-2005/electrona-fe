...
export default function ProductsTab() {
  ...
  return (
    ...
    <div className="relative bg-brand-dark pt-0 pb-24 px-6 md:px-12 lg:px-24 text-left font-sans text-white" id="products-detail-page-part2">
      <div className="absolute inset-0 cyber-grid opacity-25 pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand-cyan/5 rounded-full filter blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        ...
        <div className="mb-24 max-w-7xl mx-auto bg-white border border-neutral-200/90 rounded-3xl overflow-hidden shadow-2xl relative" id="products-comparison-grid">
