    ...
    <div className="relative min-h-screen bg-brand-dark pt-28 pb-16 px-6 md:px-12 lg:px-24 flex flex-col justify-space text-left font-sans text-white" id="sports-hub-page">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col items-start space-y-4 mb-16 border-b border-white/5 pb-8">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight font-display text-black uppercase">
            FLUID CALCULATOR
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-neutral-950/80 border border-white/5 rounded-3xl p-6 md:p-8 h-full flex flex-col justify-between">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-6" id="sports-calculator-visual-hud">
            ...
            {/* Box 1: Fluid Deficit Readout */}
            <div className="bg-neutral-950/80 border border-white/5 p-6 md:p-8 rounded-3xl space-y-6 text-left">
              <div>
              ...
              <div className="bg-brand-orange/10 border border-brand-orange/30 p-5 rounded-2xl relative">
                ...
                <p className="text-xs md:text-sm text-zinc-300 font-medium font-sans leading-relaxed">
            ...
            {/* Box 2: Sweat & Electrolyte Deletion meters */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              
              {/* Sweat Loss card */}
              <div className="bg-neutral-950/80 p-6 rounded-3xl border border-white/5 flex flex-col justify-between relative overflow-hidden text-left">
            ...
            {/* Box 3: Graphic charts - Detailed Mineral Depletion breakdown bars */}
            <div className="bg-neutral-950/80 border border-white/5 p-6 md:p-8 rounded-3xl space-y-4 text-left">
              <span className="font-mono text-zinc-500 text-[9px] tracking-widest uppercase block">
            ...
            {/* Box 4: Interactive SVG Water Canister Fluid Gauge Fills */}
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center bg-neutral-950/80 border border-white/5 p-6 rounded-3xl text-left">
            ...
            {/* Box 5: Recovery tips tailored to selected sport */}
            <div className="bg-neutral-950/80 border border-white/5 p-6 md:p-8 rounded-3xl space-y-2 text-left">
