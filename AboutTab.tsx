    ...
    <div className="relative bg-white text-left font-sans overflow-hidden" id="about-story-page">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-20 md:space-y-28">
          ...
          {/* FAQ Accordion Deck */}
          <div className="mb-20 max-w-3xl mx-auto space-y-12" id="about-faq-tabs">
            ...
            <div className="space-y-4">
              {faqs.map((faq, i) => {
                ...
                return (
                  <div 
                    key={i} 
                    className="bg-neutral-900/60 border border-white/5 rounded-xl overflow-hidden transition-all duration-300"
                    id={`fq-${i}`}
                  >
                    <button
